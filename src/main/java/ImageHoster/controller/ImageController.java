...
public class ImageController {
    ...
    public String deleteImageSubmit(@RequestParam(name = "imageId") Integer imageId, Model model, HttpSession session) {
        //Get the image using imageId
        Image delImage = imageService.getImage(imageId);
        //Get logged-in user from http session
        User loggedInUser = (User) session.getAttribute("loggeduser");

        if (delImage.getUser().getId() == loggedInUser.getId()) {
          ...
          return "redirect:/images";
            ...
            model.addAttribute("comments", delImage.getComments());
            return "images/image";
        }
    }
